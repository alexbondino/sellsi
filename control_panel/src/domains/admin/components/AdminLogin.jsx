...
const AdminLogin = ({ open, onClose }) => {
  ...
  // Si NO tiene la prop 'open', renderizar como página completa (modo standalone)
  // Esto permite usar el componente tanto como Dialog modal como página independiente
  if (open === undefined) {
    return (
  ...
  // Renderizar como modal (cuando tiene prop 'open')
  return (
    <Dialog
      open={open}
      onClose={handleClose}
