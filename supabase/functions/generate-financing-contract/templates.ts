...
SEGUNDO: NATURALEZA DEL CRÉDITO
...
QUINTO: COMISIONES
La comisión correspondiente a SELLSI SPA asciende 3% del total de la operación financiada (IVA Incluido). Dicha comisión será de cargo del PROVEEDOR y se devengará al momento de cursarse la operación en la plataforma, siendo pagadera al momento de la recaudación de los fondos.

SEXTO: INCUMPLIMIENTO Y MORA
En caso de mora del COMPRADOR superior a 10 días hábiles desde la fecha de vencimiento de la factura, el PROVEEDOR asumirá con efecto inmediato el pago de la comisión correspondiente a Sellsi respecto de dicha operación. Sellsi no asume labores de cobranza judicial ni extrajudicial.

SÉPTIMO: FIRMA ELECTRÓNICA
El presente contrato será suscrito por el PROVEEDOR y el COMPRADOR mediante Firma Electrónica Avanzada, y por SELLSI SPA en calidad de adherente, conforme a las cláusulas y disposiciones legales aplicables.

OCTAVO: LEY APLICABLE Y JURISDICCIÓN
El presente contrato se rige por las leyes de la República de Chile, sometiéndose las partes a la jurisdicción de sus tribunales ordinarios de justicia.

NOVENO: ADHESIÓN Y LÍMITES DE SELLSI SPA
SELLSI SPA declara conocer y aceptar el mandato de pago conferido y actuará con la diligencia debida en la verificación de pagos, sin asumir responsabilidad por fraudes o insolvencias ajenas a su control.
...
SELLSI SPA
RUT: 21.660.273-0
Rep: JAVIER IGNACIO ROMERO YANINE
`;