-- SCRIPT FINAL Y ROBUSTO PARA MIGRACIÓN
-- Este script está ordenado para manejar dependencias complejas.

-- PASO 1: Crear extensiones y funciones (sin dependencias de tablas)
...
-- PASO 2: Crear la estructura básica de las tablas
...
-- PASO 3: Eliminar TODAS las claves foráneas (para romper dependencias)
...
-- PASO 4: Eliminar y Recrear TODAS las claves primarias y únicas
...
-- PASO 5: Recrear TODAS las claves foráneas
