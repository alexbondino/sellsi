-- ========================================
-- MIGRACIÓN: Corregir ambigüedad de columnas en create_admin_user
-- Fecha: 2026-01-05
-- Propósito: Resolver error "column reference 'role' is ambiguous"
-- ========================================

-- Reemplazar función RPC con prefijos de tabla para evitar ambigüedad
...
-- Comentario
COMMENT ON FUNCTION create_admin_user IS 'Crea un nuevo usuario administrador con password hasheado usando bcrypt. Valida que solo admins existentes puedan crear nuevos usuarios (excepto el primer admin). Versión corregida con prefijos de tabla.';
