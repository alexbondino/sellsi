-- ========================================
-- MIGRACIÓN: Forzar recreación de create_admin_user
-- Fecha: 2026-01-05
-- Propósito: Eliminar y recrear función para resolver cache
-- ========================================

-- Eliminar función existente
DROP FUNCTION IF EXISTS create_admin_user(TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, UUID);

-- Recrear función RPC con todos los prefijos correctos
...
-- Comentario
COMMENT ON FUNCTION create_admin_user IS 'Crea un nuevo usuario administrador con password hasheado usando bcrypt. Valida que solo admins existentes puedan crear nuevos usuarios (excepto el primer admin). Versión forzada con DROP previo.';
