-- Migration: Agregar thumbnails a la vista offers_with_details
-- Esto permite que las imágenes WebP (que no tienen thumbnails) se muestren correctamente
-- Date: 2026-01-08

BEGIN;

-- Recrear la vista con campos de thumbnails
...
SELECT
  ...
  CASE
    ...
    ELSE false
  END as is_expired,
  -- ✅ NUEVOS CAMPOS al final para evitar conflictos de posición
