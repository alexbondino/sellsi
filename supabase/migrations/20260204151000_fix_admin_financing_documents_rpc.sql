-- 20260204151000_fix_admin_financing_documents_rpc.sql
-- Corregir RPC admin_get_financing_documents - reemplazar updated_at por uploaded_at
...
'RPC for admin control panel to get financing documents bypassing RLS. Uses SECURITY DEFINER.';
