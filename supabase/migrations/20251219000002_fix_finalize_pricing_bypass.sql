-- Migration: Fix finalize_order_pricing RLS bypass
-- Date: 2025-12-19
-- Description: Add bypass_order_trigger flag to finalize_order_pricing so it can update
--              orders table without being blocked by RLS trigger from 20251218000003

-- ============================================================================
-- FIX: Add bypass flag to finalize_order_pricing (SAME AS 20251219000001 + bypass)
-- ============================================================================
