// 📁 shared/constants/content/privacyContent.js
// Migrado de features/terms_policies/content.js
...
Sellsi está diseñado para empresas y profesionales. No recopilamos conscientemente información personal de menores de 18 años. Si descubrimos que hemos recopilado información de un menor, la eliminaremos inmediatamente.

**9. Cambios a esta Política**

**9.1. Notificación de Cambios**
Cualquier modificación a esta Política será comunicada mediante:
9.1.1. Email a todos los usuarios registrados
9.1.2. Aviso prominente en la plataforma
9.1.3. Actualización de la fecha en esta política

**9.2. Período de Gracia**
Los cambios entrarán en vigor 30 días después de la notificación, dando tiempo para revisar las modificaciones.
...
Para ejercer cualquier derecho, debe proporcionar identificación adecuada y especificar claramente la solicitud.

**11. Base Legal para el Tratamiento**

El tratamiento de datos personales se basa en:
11.1. Consentimiento: Para crear y mantener cuentas de usuario
11.2. Ejecución contractual: Para facilitar transacciones entre usuarios
11.3. Interés legítimo: Para mejorar la plataforma y prevenir fraudes
11.4. Cumplimiento legal: Para cumplir con obligaciones legales aplicables

**12. Autoridad de Control**

En Chile, puede dirigir consultas o reclamos sobre tratamiento de datos personales al Consejo para la Transparencia, conforme a la Ley N° 19.628.

**13. Validez y Vigencia**

Esta Política de Privacidad es válida desde la fecha de última actualización indicada al inicio del documento y permanecerá vigente hasta que sea modificada conforme a los procedimientos establecidos.

**Al utilizar la Plataforma Sellsi, confirmas que has leído, entendido y aceptas esta Política de Privacidad.**

Para cualquier consulta adicional sobre el manejo de tu información personal, no dudes en contactarnos a través de los medios indicados.
`;
