      ...
      <Table size="small">
        <TableHead>
          <TableRow sx={{ bgcolor: 'grey.50' }}>
            <TableCell sx={{ fontWeight: 600, py: 1.5 }}>Región</TableCell>
            <TableCell sx={{ fontWeight: 600, py: 1.5 }}>Valor</TableCell>
            <TableCell sx={{ fontWeight: 600, py: 1.5 }}>Tiempo</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
            ...
            >
              ...
              <TableCell sx={{ py: 1.5 }}>
                <Typography
                  variant="body2"
                  color={
                    region.shippingValue === 0 || region.shippingValue === '0'
                      ? 'success.main'
                      : 'primary.main'
                  }
                  sx={{ fontWeight: 600 }}
