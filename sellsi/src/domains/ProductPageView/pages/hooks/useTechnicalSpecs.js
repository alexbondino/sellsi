...
export const useTechnicalSpecs = () => {
  ...
  // Accept either productSlug OR productId (+ optional productName) generated by ProductCard
  const productSlug = params.productSlug || (params.productId ? `${params.productId}${params.productName ? `-${params.productName}` : ''}` : undefined)
