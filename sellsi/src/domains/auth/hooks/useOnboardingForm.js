...
export const useOnboardingForm = (onClose) => {
  ...
  const isFormValid = useCallback(() => {
    const hasBasicInfo = formData.tipoCuenta && 
      (formData.tipoCuenta === 'proveedor' ? formData.nombreEmpresa : formData.nombrePersonal) &&
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      const updates = {
        user_nm: formData.tipoCuenta === 'proveedor' ? formData.nombreEmpresa : formData.nombrePersonal,
