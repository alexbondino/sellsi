...
const SupplierOffersList = ({ offers = [], setOffers, acceptOffer, rejectOffer, deleteOffer }) => {
  ...
  const handleAccept = async (offer) => {
    try {
      ...
      showBanner({ message: `Error al aceptar la oferta`, severity: 'error', duration: 4000 });
    }
  };
  ...
  const handleReject = async (offer) => {
    try {
      ...
      showBanner({ message: `Error al rechazar la oferta`, severity: 'error', duration: 4000 });
    }
  };
  ...
  const handleCleanup = async (offer) => {
    try {
      ...
      showBanner({ message: `Error al eliminar la oferta`, severity: 'error', duration: 4000 });
    }
  };
