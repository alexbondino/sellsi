  ...
  return (
    <section className="relative w-full bg-gradient-to-br from-gray-900 via-black to-gray-900 py-24 md:py-32 lg:py-40 xl:py-56 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 -right-1/4 w-96 h-96 bg-orange-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="text-left space-y-8 animate-fade-in-up">
          ...
          <p className="text-xl text-gray-400 leading-relaxed max-w-2xl">
            <span className="font-bold text-white">Sellsi</span> es la plataforma que revoluciona el comercio B2B en Chile. 
            Conecta directamente, negocia sin fricciones y cierra negocios a cualquier escala.
          </p>
        ...
        <div className="relative flex items-center justify-center lg:justify-end animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
