  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-full md:max-w-[1200px] lg:max-w-[1400px] xl:max-w-[1800px] mx-auto px-6 sm:px-8 md:px-12 lg:px-8 xl:px-10 grid grid-cols-1 gap-12 lg:gap-20 items-center">
          {/* Left Column - Text */}
