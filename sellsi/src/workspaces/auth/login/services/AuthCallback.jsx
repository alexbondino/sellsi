...
export default function AuthCallback() {
      ...
      try {
        ...
        if (token_hash && type) {
          ...
          if (data?.user && (type === 'signup' || type === 'invite')) {
            ...
            if (!existingProfile || existingProfile.user_nm?.toLowerCase() === 'pendiente') {
              ...
              if (profileError && profileError.code !== '23505') {
                console.warn('⚠️ Error al crear/actualizar perfil:', profileError.message);
              } else {
  ...
  return (
    <div style={{ 
      ...
      <p style={{ fontSize: '1.2rem', fontWeight: 500 }}>Verificando tu cuenta...</p>
      <p style={{ fontSize: '0.9rem', color: '#666' }}>Por favor espera un momento</p>
    </div>
  );
}
