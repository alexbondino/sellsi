-- Migration: Normalize document_type in orders.items JSON array
-- Fecha: 2025-08-16
...
-- Añadir price_at_addition si falta en items JSON copiando desde price
-- y normalizar document_type.
-- NOTA: Asume que orders.items es un JSON array de objetos.
