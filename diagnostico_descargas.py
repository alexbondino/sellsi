...
def diagnosticar_descargas(directorio_descargas):
    ...
    print(f"✅ Bancos encontrados ({len(bancos_encontrados_set)}): {sorted(bancos_encontrados_set)}")
    ...
    if total_encontrado == total_esperado and not bancos_faltantes and not archivos_sin_swap and not archivos_sin_c8:
